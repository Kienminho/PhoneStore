    ...
    $.ajax({
      ...
      success: function (data) {
        ...
        if (data.statusCode === 200) {
          $("#basic-default-fullname").val(data.data.fullName);
...
//   // Retrieve the active index from localStorage
//   var activeIndex = localStorage.getItem('activeIndex');

//   // Set the initial active class based on the retrieved index
...
//       // Prevent the default page transition
